...
class Scraper:
    ...
    def scrape_year(self, login_function):
        sid, dll_link = login_function(self.driver)
        ...
        url = f'https://www8.whentowork.com/cgi-bin/{dll_link}/empfullschedule?SID={sid}&lmi=&View=Month&Date={self.start_date.strftime("%Y-%m-%d")}'
